...
import MemberList from "./pesronalInformation/MemberList";
import Beneficiary from "./Beneficiary/Beneficairy";
...
function getSteps() {
  return ['Add Beneficiary Information', 'Entrance Fee', 'Member Details'];
}
